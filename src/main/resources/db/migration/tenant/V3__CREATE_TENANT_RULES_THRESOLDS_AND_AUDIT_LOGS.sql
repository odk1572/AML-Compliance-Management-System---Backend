CREATE TABLE tenant_rule_thresholds (
    ...
    -- Cross-Schema FK: Points to the specific condition we are overriding
                                        ...
                                        override_lookback_period VARCHAR(50),
                                        override_aggregation_function VARCHAR(50),
...
CREATE TABLE tenant_audit_log (
                                  ...
                                  action_category VARCHAR(50) NOT NULL, -- e.g., USER_MGMT, RULE_MGMT, CASE_WORK
                                  action_performed VARCHAR(255) NOT NULL,
                                  target_entity_type VARCHAR(100) NOT NULL, -- e.g., USER, RULE, CASE, STR_FILING
