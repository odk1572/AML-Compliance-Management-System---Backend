-- Seed the Global Rule for Funnel Detection
...
-- Seed Condition: Originator Account Count
...
VALUES ('01954452-f349-7b2a-a92c-63b71f928e1a', 'originator_account_no', '5', 'INTEGER', 'COUNT', '7d');