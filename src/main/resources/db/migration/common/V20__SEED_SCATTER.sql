-- Seed the Global Rule for Scatter Disbursement
...
-- Seed Condition: Distinct Beneficiary Count
...
VALUES ('019c00d4-1a9e-7f32-b06d-8e4a2c5b9f31', 'distinct_beneficiary_count', '5', 'INTEGER', 'COUNT', '24h');