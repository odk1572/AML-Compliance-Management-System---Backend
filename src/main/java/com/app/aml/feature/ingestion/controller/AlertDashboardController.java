...
import com.app.aml.feature.ingestion.service.AlertDashboardService;
...
public class AlertDashboardController {
    ...
    public ResponseEntity<ApiResponse<Page<AlertResponseDto>>> getAlerts(
        ...
        Page<AlertResponseDto> data = alertDashboardService.getAlerts(severity, status, from, to, pageable);
